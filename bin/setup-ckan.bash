...
echo "Installing ckanext-mapactionschemas dependencies..."
...
pip install -e git+https://github.com/open-data/ckanext-repeating@master#egg=ckanext-repeating
echo "Installing ckanext-mapactionimporter"
pip install -e git+https://github.com/aptivate/ckanext-mapactionimporter.git@staging#egg=ckanext-mapactionevent
